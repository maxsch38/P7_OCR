...
dossier_sauvegarde = '/Users/maxime/Formation Data Scientist /Projets /7 - Implementez un modele de scoring/2. Sauvegardes'

# Data test : 
data_test = chargement_pickle(
    name='data_final_test',
    chemin=dossier_sauvegarde,
)

# Data train : 
data_train = chargement_pickle(
