...
###########################################################################################################################
# Fonction de gestion des données pickle : 
...
dossier_sauvegarde = '/Users/maxime/Formation Data Scientist /Projets /7 - Implementez un modele de scoring/2. Sauvegardes/models'

# Pipeline : 
pipeline = chargement_pickle(
    name='Pipeline_RandomForest',
    chemin=dossier_sauvegarde,
)

# Threshold spécifique : 
threshold = chargement_pickle(
    name='Threshold_RandomForest',
    chemin=dossier_sauvegarde, 
)
